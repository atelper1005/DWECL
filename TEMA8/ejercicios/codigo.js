  ...
  constructor() {
    this.productos = [
        new Producto(
            ...
            "Zapatos",
            45, 
            "https://loremflickr.com/320/240/shoes"
            ),
        new Producto(
            2,
            "Móvil",
            199.99,
            "https://loremflickr.com/320/240/smartphone"
        ),
        new Producto(
            3, 
            "Vestido", 
            30, 
            "https://loremflickr.com/320/240/dress"
            ),
        new Producto(
            4,
            "Ratón inalámbrico",
            15.5,
            "https://loremflickr.com/320/240/wireless_mouse"
        ),
        new Producto(
            5,
            "Maceta",
            27.9,
            "https://loremflickr.com/320/240/flowerpot"
        ),
        new Producto(
            6, 
            "Collar", 
            50, 
            "https://loremflickr.com/320/240/necklace"
        )
    ];
  }
}
...
class Cesta {
  ...
  renderizarProductos() {
    ...
    contProductos.productos.forEach((info) => {
      ...
      miNodoBoton.addEventListener("click", () =>
        this.anadirProductoCarrito(info.id)
      );
  ...
  renderizarCarrito() {
    ...
    carritoSinDuplicados.forEach((item) => {
      ...
      const miItem = this.contProductos.productos.find(
        (itemProducto) => itemProducto.id === parseInt(item)
      );
      const numeroUnidadesItem = this.carrito.reduce(
